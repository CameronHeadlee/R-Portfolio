...
import MyPDF from "../../assets/Resume_2.PDF";
    ...
    <div className="main">
      <div class="container">
        ...
        <div className="col d-flex justify-content-center">
          <a href={MyPDF} download="Resume_2.PDF">
        ...
        <div className="col-md-auto">
          <h2 className="skill text-center pt-2">
            Technical Skills:
          </h2>
            <ListGroup variant="flush">
              ...
              <ListGroup.Item className="text-center">
                jQuery\React.js\Handlebars</ListGroup.Item>
              <ListGroup.Item className="text-center">
              ...
              <ListGroup.Item className="text-center">
                User Auth\PWAs\MERN Stack
              </ListGroup.Item>
              <ListGroup.Item className="text-center">
                Git\Heroku\GitHub Pages
              </ListGroup.Item>
            </ListGroup>
        </div>
        <div className="col-md-auto">
